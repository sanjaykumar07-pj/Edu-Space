  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex justify-between items-end mb-2">
        <div>
          <h2 className="font-headline-lg text-on-surface">Academic Analytics</h2>
          <p className="text-on-surface-variant mt-1">Platform-wide academic performance.</p>
        </div>
      </div>

      <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm flex flex-col min-h-[400px]">
        <h3 className="font-headline-sm text-on-surface mb-6">Average Grade Trend</h3>
